...
[`@aws-sdk/client-signin`](https://www.npmjs.com/package/@aws-sdk/client-signin/v/3.1078.0).
...
- @aws-sdk/client-signin v3.1078.0 - [https://cloud-sdk-builds.github.io/?sdk=client-signin&version=3.1078.0](https://cloud-sdk-builds.github.io/?sdk=client-signin&version=3.1078.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signin@3.1078.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MaKP5hWvM4lOBFgijOJfCWxaRLDbb/iAvZNKDzz/eZTltk+7iRl4OVnp0k6hdNzQ
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signin/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-signin": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signin@3.1078.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-signin@3.1078.0/index.min.mjs": "sha384-MaKP5hWvM4lOBFgijOJfCWxaRLDbb/iAvZNKDzz/eZTltk+7iRl4OVnp0k6hdNzQ"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-signin";
...
```
https://github.com/cloud-sdk-builds/client-signin/blob/refs/tags/3.1078.0/LICENSE
```
